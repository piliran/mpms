      ...
      <div class="row">
         <div class="procure-nav p-0">
            ...
            <div class="list-group list-group-flush">
               ...
               <a href="suppliers.php" class="list-group-item text-light procure-link <?= (basename($_SERVER['PHP_SELF'])=='supplier.php')?"nav-active":"" ?>"><i class="fas fa-user-friends"></i>&nbsp;&nbsp; Suppliers</a>
